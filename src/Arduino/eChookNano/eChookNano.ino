...
/* WHEEL & MOTOR SPEED */
const unsigned long     WHEEL_MAGNETS                    = 3;       // Number of magnets on wheel for hall effect sensor
const unsigned long     MOTOR_MAGNETS                    = 1;       // Number of magnets on motor shaft for hall effect sensor
const double            WHEEL_CIRCUMFERENCE              = 0.42 * 3.14;    // in meters -- wheel diameter = 420mm
...
float readWheelSpeed() //wheelRPM is also updated whenever this is called
{
  ...
  long tempLastWheelPollTime = lastWheelSpeedPollTime;
...
float readMotorRPM()
{
  ...
  long tempLastMotorPollTime = lastMotorSpeedPollTime;
  long tempMotorPollTime = millis();
